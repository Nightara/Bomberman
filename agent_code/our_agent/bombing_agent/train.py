...
from .BombingTraining import generate_eps_greedy_policy, add_experience, get_score, track_game_score, save_parameters, update_network, train_network, reward_from_events, rewards_from_own_events
...
def setup_training(self):
    ...
    if not TRAIN_FROM_SCRATCH: #load current parameters
