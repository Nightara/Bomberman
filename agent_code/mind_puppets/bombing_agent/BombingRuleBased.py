...
def initialize_rule_based(self):
    ...
    # coins
    self.action_array[0][0] = 200
    self.action_array[1][1] = 200
    self.action_array[2][2] = 200
    self.action_array[3][3] = 200
    ...
    self.action_array[0][14] = 500
    self.action_array[1][15] = 500
    self.action_array[2][16] = 500
    self.action_array[3][17] = 500